...
Nous allons tenter de crack le mdp ssh de Jake à l'aide d'hydra en faisant cette commande:
...
Regardons les privilèges de Jake
```
...
Jake peut s'exécuter moins en tant que root sans mot de passe. Obtenons le drapeau racine :
